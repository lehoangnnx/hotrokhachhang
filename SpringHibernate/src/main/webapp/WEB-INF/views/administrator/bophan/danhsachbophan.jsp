...
<%--<section class="content-header">
	<h1>
		Bộ Phận
		&lt;%&ndash; <small><a href="${contextPath }/admin/roles?status=active">Danh Sách Bộ Phận</a></small> &ndash;%&gt;
		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-header">
					...
					<a class="btn btn-success pull-right" href="${contextPath }/admin/bophan/add">Thêm
						mới</a>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
