...
<%--    <section class="content-header">
      <h1>
        Nhóm Khách Hàng
        &lt;%&ndash; <small><a href="${contextPath }/admin/roles?status=active">Danh Sách Nhóm Khách Hàng</a></small>
        <small><a class="btn btn-success" href="${contextPath }/admin/nhomkhachhang/add">Thêm mới</a></small> &ndash;%&gt;
      </h1>
      <ol class="breadcrumb">
      <a class="btn btn-success" href="${contextPath }/admin/nhomkhachhang/add">Thêm mới</a>
      ...
      <div class="row">
		        ...
		        <div class="col-xs-12">
		          <ul class="nav nav-tabs">
					...
					<a href="${contextPath }/admin/nhomkhachhang?trangthai=active"   >Đã Kích Hoạt</a>
					</li>

					<li class="tablinks ${param.trangthai == 'deleted' ? 'active' : '' }">
					<a href="${contextPath }/admin/nhomkhachhang?trangthai=deleted"  >Đã Xóa</a>
					</li>
				</ul>
		          <div class="box">
		            <div class="box-header">
		              <h3 class="box-title">Danh Sách Nhóm Khách Hàng</h3>
						<a class="btn btn-success pull-right" href="${contextPath }/admin/nhomkhachhang/add">Thêm mới</a>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		             <div class="table-responsive">
		                ...
		                <c:forEach var="nkh" items="${listNhomkhachhang }" >
		                	<tr>
			                  	...
			                  	<td>
			                  		<a href="${contextPath }/admin/nhomkhachhang/${nkh.id}">
			                  			<i style="color: blue;" class="fa fa-pencil fa-lg" aria-hidden="true" title="Sửa">
			                  			</i>
			                  		</a> 
			                  		<c:if test="${nkh.trangthai != 'deleted' }">
			                  		<a onclick="deleteOne(${nkh.id});" href="#" data-toggle="modal" data-target="#myModal"
