...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Nhóm Khách Hàng
        <%-- <small><a href="${contextPath }/admin/roles?status=active">Danh Sách Nhóm Khách Hàng</a></small>
        <small><a class="btn btn-success" href="${contextPath }/admin/nhomkhachhang/add">Thêm mới</a></small> --%>
      </h1>
      <ol class="breadcrumb">
