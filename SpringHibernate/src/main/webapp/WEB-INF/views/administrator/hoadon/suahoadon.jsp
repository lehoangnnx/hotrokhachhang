                ...
                <form:form role="form" id="formHoaDon"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="sohoadon" name="sohoadon" type="text" class="form-control" readonly value="${hoadon.sohoadon}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="ngaylap" onchange="checkngay(event);" id="ngaylap"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="ngayxuat" onchange="checkngay(event);" id="ngayxuat"
                                       value="<fmt:formatDate
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="ngaythanhtoan" onchange="checkngay(event);" id="ngaythanhtoan"
                                       value="<fmt:formatDate
                    ...
                    <security:authorize access="hasAnyRole('ADMIN','BANHANG')">
                        <c:if test="${hoadon.trangthai != 'deleted' }">
                                ...
                                <button id="btn-submit" name="update" onclick="checkngay(event);" type="submit"
