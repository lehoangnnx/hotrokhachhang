		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<form:form role="form" id="formKhachHang"
					action="${contextPath }/admin/khachhang" method="post"
					...
					<div class="form-group">
						<label>Loại Khách Hàng</label> <select
							...
							<c:forEach var="lkh" items="${listLoaikhachhang }">
								<option value="${lkh.id }">${lkh.tenloai}</option>
							</c:forEach>
					...
					<div class="form-group">
						<label>Nhóm Khách Hàng</label> <select
							...
							<c:forEach var="nkh" items="${listNhomkhachhang }">
								<option value="${nkh.id }">${nkh.tennhom}</option>
							</c:forEach>
						...
						<div class="form-group">
							...
							<form:input path="diem" type="number" class="form-control" min="0" value="0"
								placeholder="Điểm" />
						...
						<div class="form-group">
							...
							<form:input path="solanchamsoc" type="number" min="0" value="0"
						...
						<div class="form-group">
							...
							<form:input path="solandamphan" type="number" min="0" value="0"
						...
						<div class="form-group">
							...
							<form:input path="diemtiemnang" type="number" min="0" value="0"
