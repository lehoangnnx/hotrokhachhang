...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
       Khách Hàng
        <small><a href="${contextPath }/admin/roles?status=active">Danh Sách Khách Hàng</a></small>
        <small><a class="btn btn-success" href="${contextPath }/admin/khachhang/add">Thêm mới</a></small>
      </h1>
      <ol class="breadcrumb">
		            ...
		            <div class="box-body">
		                ...
		                <c:forEach var="kh" items="${listKhachhang }" >
		                	<tr>
			                  	...
			                  	<td>
			                  		<a href="${contextPath }/admin/khachhang/${kh.id}">
			                  			<i style="color: blue;" class="fa fa-pencil fa-lg" aria-hidden="true" title="Sửa">
			                  			</i>
			                  		</a> 
			                  		<a onclick="deleteOne(${kh.id});" href="#" data-toggle="modal" data-target="#myModal"
