            ...
            <div class="box box-primary">
                ...
                <form:form role="form" id="formKhachHang"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="lanmuahang">Số Lần Mua Hàng</label>
                            <input id="lanmuahang" name="lanmuahang" type="number" min="0" readonly value="${khachhang.lanmuahang}"
                                        class="form-control" placeholder="Số Lần Mua Hàng"/>
