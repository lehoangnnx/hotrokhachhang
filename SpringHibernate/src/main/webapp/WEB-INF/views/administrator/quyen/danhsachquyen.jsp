...
<!-- Content Header (Page header) -->
   <%-- <section class="content-header">
      <h1>
        Quyền
        &lt;%&ndash; <small><a href="${contextPath }/admin/roles?status=active">Danh Sách Quyền</a></small>
        <small><a class="btn btn-success" href="${contextPath }/admin/quyen/add">Thêm mới</a></small> &ndash;%&gt;
      </h1>
      <ol class="breadcrumb">
      <a class="btn btn-success" href="${contextPath }/admin/quyen/add">Thêm mới</a>
      ...
      <div class="row">
		        ...
		        <div class="col-xs-12">
		          <ul class="nav nav-tabs">
					...
					<a href="${contextPath }/admin/quyen?trangthai=active"   >Đã Kích Hoạt</a>
					</li>

					<li class="tablinks ${param.trangthai == 'deleted' ? 'active' : '' }">
					<a href="${contextPath }/admin/quyen?trangthai=deleted"  >Đã Xóa</a>
					</li>
				</ul>
		          <div class="box">
		            <div class="box-header">
		              <h3 class="box-title">Danh Sách Quyền</h3>
						<a class="btn btn-success pull-right" href="${contextPath }/admin/quyen/add">Thêm mới</a>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
