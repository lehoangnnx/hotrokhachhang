...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
      <a class="btn btn-success" href="${contextPath }/admin/kpi/add">Thêm mới</a>
      ...
      <div class="row">
		        ...
		        <div class="col-xs-12">
		          <ul class="nav nav-tabs">
					...
					<a href="${contextPath }/admin/kpi?trangthai=active"   >Đã Kích Hoạt</a>
					</li>
		            ...
		            <div class="box-body">
		                ...
		                <c:forEach var="kpi" items="${listKpi }" >
		                	<tr>
			                  	...
			                  	<td>
			                  		<a href="${contextPath }/admin/kpi/${kpi.id}">
			                  			<i style="color: blue;" class="fa fa-pencil fa-lg" aria-hidden="true" title="Sửa">
			                  			</i>
			                  		</a> 
			                  		<a onclick="deleteOne(${kpi.id});" href="#" data-toggle="modal" data-target="#myModal"
