...
<%--    <section class="content-header">
      <h1>
       Nhân Viên
        &lt;%&ndash; <small><a href="${contextPath }/admin/roles?status=active">Danh Sách Nhân Viên</a></small>
        <small><a class="btn btn-success" href="${contextPath }/admin/nhanvien/add">Thêm mới</a></small> &ndash;%&gt;
      </h1>
      <ol class="breadcrumb">
		          ...
		          <div class="box">
		            <div class="box-header">
		              <h3 class="box-title">Danh Sách Nhân Viên</h3>
						<a class="btn btn-success pull-right" href="${contextPath }/admin/nhanvien/add">Thêm mới</a>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		                	...
		                	<tr>
			                  ...
			                  <td>${nv.bophan.tenbophan }</td>
			                  	<td>
			                  		...
			                  		<c:if test="${nv.trangthai != 'deleted' }">
