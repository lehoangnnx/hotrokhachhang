...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
      <a class="btn btn-success" href="${contextPath }/admin/hanghoa/add">Thêm mới</a>
      ...
      <div class="row">
		        ...
		        <div class="col-xs-12">
		          <ul class="nav nav-tabs">
					...
					<a href="${contextPath }/admin/hanghoa?trangthai=active"   >Đã Kích Hoạt</a>
					</li>

					<li class="tablinks ${param.trangthai == 'deleted' ? 'active' : '' }">
					<a href="${contextPath }/admin/hanghoa?trangthai=deleted"  >Đã Xóa</a>
					</li>
				</ul>
		          <div class="box">
		            <div class="box-header">
		              <h3 class="box-title">Danh Hàng Hóan</h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
		                ...
		                <c:forEach var="hh" items="${listHanghoa }" >
		                	<tr>
			                  ...
			                  <td>${hh.gianhap }</td>
			                  <td>${hh.giaban }</td>
			                  <td>${hh.giakhuyenmai }</td>
			                  <td>${hh.donvitinh }</td>
			                  <td>${hh.mota }</td>
			                  	
			                  	<td>
			                  		<a href="${contextPath }/admin/hanghoa/${hh.id}">
			                  			<i style="color: blue;" class="fa fa-pencil fa-lg" aria-hidden="true" title="Sửa">
			                  			</i>
			                  		</a> 
			                  		<c:if test="${hh.trangthai != 'deleted' }">
			                  		<a onclick="deleteOne(${hh.id});" href="#" data-toggle="modal" data-target="#myModal"
