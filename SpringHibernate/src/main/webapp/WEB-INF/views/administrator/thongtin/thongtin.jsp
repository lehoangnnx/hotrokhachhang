                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <button style="margin-top: 25px;" type="submit" id="btn-submit"
                                        class="btn btn-block btn-success btn-flat">Xem Lương
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                    Lương :<strong><fmt:formatNumber type="number"
                                                     pattern="###,###" value="${nhanvien.luong }"/> &#8363; </strong>
                    <br>
                    ...
                    <div class="col-xs-12 table-responsive">
                        <table class="table table-striped">
                            ...
                            <c:if test="${not empty luong }">
                                ...
                                <c:forEach var="ul" items="${luong.ungluongs}">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tr>
                                ...
                                <td><input id="pwd" type="password" class="form-control" placeholder="Mật Khẩu Mới"/>
                                </td>
                            </tr>
                            <tr>
