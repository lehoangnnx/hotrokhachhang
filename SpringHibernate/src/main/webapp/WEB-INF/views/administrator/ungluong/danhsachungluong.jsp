...
<!-- Content Header (Page header) -->
  <%--  <section class="content-header">
      <h1>
       Ứng Lương
        &lt;%&ndash; <small><a href="${contextPath }/admin/roles?status=active">Danh Sách Lương</a></small>
        <small><a class="btn btn-success" href="${contextPath }/admin/luong/add">Thêm mới</a></small> &ndash;%&gt;
      </h1>
      <ol class="breadcrumb">
		          ...
		          <div class="box">
		            <div class="box-header">
		              <h3 class="box-title">Danh sách Ứng Lương</h3>
						<a class="btn btn-success pull-right" href="${contextPath }/admin/ungluong/add">Thêm mới</a>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
