...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Nhóm Hàng
        <small><a href="${contextPath }/admin/roles?status=active">Danh Sách Nhóm Hàng</a></small>
        <small><a class="btn btn-success" href="${contextPath }/admin/nhomhang/add">Thêm mới</a></small>
      </h1>
      <ol class="breadcrumb">
		                ...
		                <c:forEach var="nh" items="${listNhomhang }" >
		                	<tr>
			                  ...
			                  <td>${nh.mota }</td>
			                  	...
			                  	<td>
			                  		<a href="${contextPath }/admin/nhomhang/${nh.id}">
			                  			<i style="color: blue;" class="fa fa-pencil fa-lg" aria-hidden="true" title="Sửa">
			                  			</i>
			                  		</a> 
			                  		<a onclick="deleteOne(${nh.id});" href="#" data-toggle="modal" data-target="#myModal"
