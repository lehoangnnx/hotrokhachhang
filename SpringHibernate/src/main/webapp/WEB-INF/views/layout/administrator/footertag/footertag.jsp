...
<script
	src="${contexPath }/js/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
<script
	src="${contexPath }/js/plugins/input-mask/jquery.inputmask.extensions.js"></script>
<!-- date-range-picker -->
<script
	src="${contexPath }/js/moment.min.js"></script>
<script
	src="${contexPath }/js/plugins/daterangepicker/daterangepicker.js"></script>
<!-- bootstrap datepicker -->
<script
	src="${contexPath }/js/plugins/datepicker/bootstrap-datepicker.js"></script>


<!-- bootstrap time picker -->
<script
	src="${contexPath }/js/plugins/timepicker/bootstrap-timepicker.min.js"></script>
